...
Use the `microsoft-docs` skill to retrieve up-to-date documentation about Microsoft-related topics including Microsoft Azure. Do not use the MCP server, use the CLI variant.
