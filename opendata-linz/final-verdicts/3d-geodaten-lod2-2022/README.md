...
| Catalog | [3D Geodaten mit Level of Detail2 2022](https://www.data.gv.at/katalog/datasets/d0500244-6b9e-4d3c-9def-70703c013b3f) |
| Data access | [2022 directory](https://data.linz.gv.at/katalog/geodata/3d_geo_daten/2022/) and [tile index CSV](https://data.linz.gv.at/katalog/geodata/3d_geo_daten/2022/Uebersicht.csv) |
| Format | CityGML 1.0, DXF, JPEG textures, CSV tile index and PDF sheet overview |
...
| Data vintage | Derived from aerial surveys made in 2019–2021; published as the 2022 model |
| Last verified | 2026-07-15: catalog evidence reviewed; source files were observed on 2026-07-13 and were not re-fetched on 2026-07-15 because the check could not resolve the publisher host |

## What the dataset contains

The source is a tiled three-dimensional city model, not one citywide file. The
2026-07-13 source review counted 834 rows in `Uebersicht.csv`. Each row points to
the relevant GML, DXF and image-folder resources. A representative building GML
was valid CityGML 1.0 from a CityGRID export, contained `bldg:Building` members,
and used `app:ParameterizedTexture` references to JPEGs below `images/`. The
reviewed GML was about 350 KB before its textures; this is not a reliable average
for all tiles.
...
Use `Uebersicht.csv` or the [PDF sheet overview](https://data.linz.gv.at/katalog/geodata/3d_geo_daten/2022/01-Uebersicht.pdf)
...
- The model reflects 2019–2021 source imagery, not the 2026 city. A catalog note
  anticipated a 2023/2024 refresh, but no such refresh was established in this
...
- An optional visual installation contrasting the 2022 city model with festival
...
2. Intersect those points with the sheet grid and download only the required
   `M_*`/`H_*` resources and their referenced textures.
...
- [Official 2022 source directory](https://data.linz.gv.at/katalog/geodata/3d_geo_daten/2022/)
- [Official tile index](https://data.linz.gv.at/katalog/geodata/3d_geo_daten/2022/Uebersicht.csv)
- [Hands-on source review](../../2026-07-13-reviews-rainer/3d-geodaten-lod2-2022.md) (observations dated 2026-07-13)
