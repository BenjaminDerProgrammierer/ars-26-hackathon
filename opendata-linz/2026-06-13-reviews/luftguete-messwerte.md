...
**Verdict:** ✅ Recommended — live, current air-quality + weather data with named Linz stations that map cleanly onto festival venue geography.
...
- 9 distributions, one live "letzte 24 Stunden" JSON endpoint per station: 24er-Turm, Freinberg-Sender, Römerberg, Goethestraße, Stadtpark, Schlossmuseum, Chemiepark, Sternwarte, Neue Welt — all in/around Linz.
...
- Rolling 24h window: ~48 half-hourly samples per component per station; endpoints responded fast and well-formed.
